...
import com.codebean.UserService.repository.PermissionsRepository;
...
public class PermissionIService implements iService<Permissions> {
    ...
    @Override
    public ResponseEntity<Object> save(Permissions permissions, HttpServletRequest request) {
        return null;
    }

    @Override
    public ResponseEntity<Object> update(Long id, Permissions permissions, HttpServletRequest request) {
        return null;
    }
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        try {
            ...
            Iterable<Permissions> all = this.permissionsRepository.findAll();
